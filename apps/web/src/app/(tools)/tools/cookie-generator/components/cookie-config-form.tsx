  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        <label className="text-[13px] font-medium text-foreground">Типы cookie</label>
                ...
                <div className="flex min-w-0 flex-1 items-center gap-2">
                  <div>
                    ...
                    {isAutoSynced && !ct.required && (
                      <span className="ml-1.5 rounded bg-foreground/[0.05] px-1.5 py-0.5 text-[10px] font-medium text-foreground/70">
        ...
        <div className="space-y-2">
          {([
            ...
            >
              ...
              <span className={`text-muted-foreground ${documentSettings.businessScenario[key] ? 'text-foreground' : ''}`}>
                {icon}
              </span>
              <div className="min-w-0">
                <span className="text-[13px] font-medium text-foreground">{label}</span>
                <span className="ml-2 text-[12px] text-muted-foreground">{desc}</span>
              </div>
            </label>
          ))}
        </div>
      ...
      <div className="space-y-3">
        <label className="text-[13px] font-medium text-foreground">Системы аналитики</label>
        <div className="space-y-2">
            ...
            >
              ...
              <div className="flex min-w-0 flex-1 items-center gap-2">
                ...
                {!tool.isCrossBorder && tool.country === 'RU' && (
                  <span className="rounded bg-foreground/[0.06] px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground">RU</span>
                )}
                {tool.isCrossBorder && tool.country && <CrossBorderTooltip country={tool.country} />}
              </div>
            </label>
          ))}
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <span className="text-[13px] font-medium text-foreground">Другое</span>
            </label>
      ...
      {/* Block 4: Marketing */}
      <div className="space-y-3">
        <label className="text-[13px] font-medium text-foreground">Маркетинг и реклама</label>
        <div className="space-y-2">
          {([
            {
      ...
      {/* Block 5: Document Tone — last, as a stylistic finishing choice */}
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2" role="radiogroup" aria-label="Тон документа">
          {([
            ...
            <button
              ...
              className={`group flex cursor-pointer flex-col items-center gap-2 rounded-lg border p-3 text-center transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
                documentSettings.tone === value
                  ? 'border-foreground/30 bg-foreground/[0.03] text-foreground'
                  : 'border-border bg-card text-muted-foreground hover:border-border hover:text-foreground'
              }`}
            >
              <span className={documentSettings.tone === value ? 'text-foreground' : 'text-muted-foreground/70'}>{icon}</span>
...
function CrossBorderTooltip({ country }: { country: string }) {
  return (
