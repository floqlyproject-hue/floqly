...
export const TOOLS_REGISTRY: Tool[] = [
  ...
  },
  {
    id: 'smart-widget',
    name: 'Умный виджет',
    description: 'Чат, который сам отвечает на вопросы',
    longDescription: 'Умный виджет для сайта. Автоматически отвечает на вопросы клиентов на основе данных вашей компании.',
    status: 'coming_soon',
    category: 'engagement',
    icon: 'sparkles',
    isPremium: true,
    features: ['Автоматические ответы', 'Данные компании', 'Обучение на ваших данных'],
  },
  {
    id: 'feedback-widget',
    name: 'Сбор отзывов',
